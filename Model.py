...
class GlobalGraphNet(nn.Module):
    def __init__(self, cat_len, poi_len, cat_dim, poi_dim, gcn_channel, gcn_layers, graph_out_dim, gps_dim, lat_len, long_len):
...
class GlobalDistNet(nn.Module):
    def __init__(self,  poi_dim, poi_len, graph_features, gcn_channel, gcn_layers, graph_out_dim):
...
class UserGraphNet(nn.Module):
    def __init__(self, cat_len, poi_len, cat_dim, poi_dim, gcn_channel, gcn_layers, gps_dim, node_len, graph_out_dim, lat_len, long_len):
...
class UserHistoryNet(nn.Module):
    def __init__(self, cat_len, poi_len, user_len, embed_size_user, embed_size_poi, embed_size_cat, embed_size_hour, hidden_size, lstm_layers, history_out_dim):
...
class TransformerModel(nn.Module):
    def __init__(self, embed_dim, dropout, tran_head, tran_hid, tran_layers, poi_len, attention_layers, neighobr_len):
